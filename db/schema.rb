...
ActiveRecord::Schema.define(version: 20161219185036) do
  ...
  add_index "downloads", ["css_id", "user_station_id"], name: "index_downloads_on_css_id_and_user_station_id", using: :btree
